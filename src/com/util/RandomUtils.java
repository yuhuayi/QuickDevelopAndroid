...
public class RandomUtils {
     ...
     * @param length
     * @return
     * @see com.goldav.goldavB2C.util.RandomUtils#getRandom(String source, int length)
     */
     ...
     * <li>else see {@link com.goldav.goldavB2C.util.RandomUtils#getRandom(char[] sourceChar, int length)}</li>
     * </ul>
     */
