...
//        return Bitmap.createBitmap(bitmap, retX, retY, wh, wh, null, false);
     ...
     * 选择图片打开方式
     */
    public static void doCustomPickPhotoAction(final Activity acvity, int CODE, final int CAMERA_WITH_DATA1,
                                               final int PHOTO_PICKED_WITH_DATA1, String title, String content, String leftTx, String rightTxCarmer) {
        AppConstants.current_page_take_pic = CODE;
        alertDialog = PromptManager.showCustomDialog(acvity, title, content, leftTx, rightTxCarmer, new View.OnClickListener() {

                    @Override
                    public void onClick(View view) {
                        doPickPhotoFromGallery(acvity, PHOTO_PICKED_WITH_DATA1);// 从相册中去获取
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (status.equals(Environment.MEDIA_MOUNTED)) {// 判断是否有SD卡
                            doTakePhoto(acvity, CAMERA_WITH_DATA1);// 用户点击了从照相机获取
                        }
                        if (alertDialog != null || alertDialog.isShowing())
                            alertDialog.dismiss();
                    }
     ...
     * 选择图片打开方式
     */
//	public static void doPickPhotoAction(final Activity acvity, final String PHOTO_DIR, final int CAMERA_WITH_DATA1,
//			final int PHOTO_PICKED_WITH_DATA1) {
//		final Context dialogContext = new ContextThemeWrapper(acvity, android.R.style.Theme_Light);
...
//					String status = Environment.getExternalStorageState();
//					if (status.equals(Environment.MEDIA_MOUNTED)) {// 判断是否有SD卡
//						doTakePhoto(acvity, PHOTO_DIR, CAMERA_WITH_DATA1);// 用户点击了从照相机获取
//					} else {
//						// PromptManager.showToast(acvity, "没有SD卡");
//					}
//					break;
//				case 1:
//					doPickPhotoFromGallery(acvity, PHOTO_PICKED_WITH_DATA1);// 从相册中去获取
