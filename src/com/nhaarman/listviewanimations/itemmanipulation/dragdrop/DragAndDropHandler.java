 ...
 * {@link com.nhaarman.listviewanimations.util.Swappable} {@link android.widget.ListAdapter}.
...
public class DragAndDropHandler implements TouchEventHandler {
     ...
     * <p/>
     * Applies the {@link android.view.MotionEvent} to the hover drawable, and switches {@code View}s if necessary.
     *
     * @param event the {@code MotionEvent}.
     *
     * @return {@code true} if the event was handled, {@code false} otherwise.
