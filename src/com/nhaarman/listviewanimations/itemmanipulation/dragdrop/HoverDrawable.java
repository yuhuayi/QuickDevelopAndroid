...
/**
 * A Drawable which represents a dragging {@link android.view.View}.
 */
class HoverDrawable extends BitmapDrawable {
    ...
    /**
     * Creates a new {@code HoverDrawable} for given {@link android.view.View}, using given {@link android.view.MotionEvent}.
     *
    ...
    /**
     * Calculates the new position for this {@code HoverDrawable} using given {@link android.view.MotionEvent}.
     *
     * @param ev the {@code MotionEvent}.
     *           {@code ev.getActionMasked()} should typically equal {@link android.view.MotionEvent#ACTION_MOVE}.
     */
