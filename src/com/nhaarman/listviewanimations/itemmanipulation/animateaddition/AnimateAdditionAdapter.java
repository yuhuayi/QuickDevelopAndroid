...
/**
 * An adapter for inserting rows into the {@link android.widget.ListView} with an animation. The root {@link android.widget.BaseAdapter} should implement {@link com.nhaarman.listviewanimations.util.Insertable},
...
public class AnimateAdditionAdapter<T> extends BaseAdapterDecorator {
     ...
     *
     * @param baseAdapter should implement {@link com.nhaarman.listviewanimations.util.Insertable},
     ...
     * Will also call {@link com.nhaarman.listviewanimations.util.Insertable#add(int, Object)} of the root {@link android.widget.BaseAdapter}.
     *
