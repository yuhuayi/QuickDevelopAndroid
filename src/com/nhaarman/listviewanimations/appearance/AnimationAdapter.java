...
/**
 * A {@link BaseAdapterDecorator} class which applies multiple {@link com.nineoldandroids.animation.Animator}s at once to views when they are first shown. The Animators applied include the animations specified
