...
public class HttpUtils {
    ...
    private static HttpRedirectHandler httpRedirectHandler;
    ...
    private static String responseTextCharset = HTTP.UTF_8;

    private static long currentRequestExpiry = HttpCache.getDefaultExpiryTime();
    ...
    public static HttpHandler<File> download(HttpRequest.HttpMethod method, String url, String target,
                                             RequestParams params, boolean autoResume, boolean autoRename, RequestCallBack<File> callback) {
