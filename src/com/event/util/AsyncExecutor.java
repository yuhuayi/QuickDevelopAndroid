...
/**
 * Executes an {@link com.event.util.AsyncExecutor.RunnableEx} using a thread pool. Thrown exceptions are propagated by posting failure events of any
...
public class AsyncExecutor {
    ...
    /** Posts an failure event if the given {@link com.event.util.AsyncExecutor.RunnableEx} throws an Exception. */
