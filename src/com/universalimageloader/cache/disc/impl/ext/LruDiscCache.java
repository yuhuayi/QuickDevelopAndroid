 ...
 * {@link com.universalimageloader.cache.disc.impl.ext.DiskLruCache
 * DiskLruCache} to {@link com.universalimageloader.cache.disc.DiskCache
 * DiskCache}
 * 
...
public class LruDiscCache implements DiskCache {
	 ...
	 *            {@linkplain com.universalimageloader.cache.disc.naming.FileNameGenerator
	 ...
	 *             "No space left on device")
	 */
	public LruDiscCache(File cacheDir, File reserveCacheDir, FileNameGenerator fileNameGenerator, long cacheMaxSize, int cacheMaxFileCount)
			throws IOException {
		if (cacheDir == null) {
