 ...
 * <ul>
 * <li>whether stub image will be displayed in {@link com.universalimageloader.core.imageaware.ImageAware
 ...
 * <li>whether {@link com.universalimageloader.core.imageaware.ImageAware image aware view} should be reset
 ...
 * <li>auxiliary object which will be passed to {@link com.universalimageloader.core.download.ImageDownloader#getStream(String, Object) ImageDownloader}</li>
 ...
 * <ul>
 * <li>with {@link com.universalimageloader.core.DisplayImageOptions.Builder}:<br />
 * <b>i.e.</b> :
 * <code>new {@link DisplayImageOptions}.{@link com.universalimageloader.core.DisplayImageOptions.Builder#Builder() Builder()}.{@link com.universalimageloader.core.DisplayImageOptions.Builder#cacheInMemory() cacheInMemory()}.
 * {@link com.universalimageloader.core.DisplayImageOptions.Builder#showImageOnLoading(int) showImageOnLoading()}.{@link com.universalimageloader.core.DisplayImageOptions.Builder#build() build()}</code><br />
 * </li>
...
public final class DisplayImageOptions {
	...
	public static class Builder {
		...
		/**
		 * Stub image will be displayed in {@link com.universalimageloader.core.imageaware.ImageAware
		...
		/**
		 * Incoming image will be displayed in {@link com.universalimageloader.core.imageaware.ImageAware
		 * image aware view} during image loading
		 *
		...
		/**
		 * Incoming drawable will be displayed in {@link com.universalimageloader.core.imageaware.ImageAware
		 * image aware view} during image loading.
		 * This option will be ignored if {@link com.universalimageloader.core.DisplayImageOptions.Builder#showImageOnLoading(int)} is set.
		 */
		 ...
		 * image aware view} if empty URI (null or empty
		 * string) will be passed to <b>ImageLoader.displayImage(...)</b> method.
		 * This option will be ignored if {@link com.universalimageloader.core.DisplayImageOptions.Builder#showImageForEmptyUri(int)} is set.
		 */
		 ...
		 * image aware view} if some error occurs during
		 * requested image loading/decoding.
		 * This option will be ignored if {@link com.universalimageloader.core.DisplayImageOptions.Builder#showImageOnFail(int)} is set.
		 */
		...
		/**
		 * {@link com.universalimageloader.core.imageaware.ImageAware
		...
		/**
		 * Sets whether {@link com.universalimageloader.core.imageaware.ImageAware
		 * image aware view} will be reset (set <b>null</b>) before image loading start
		 */
		...
		/**
		 * Sets {@linkplain com.universalimageloader.core.assist.ImageScaleType scale type} for decoding image. This parameter is used while define scale
		 * size for decoding image to Bitmap. Default value - {@link com.universalimageloader.core.assist.ImageScaleType#IN_SAMPLE_POWER_OF_2}
		 */
		 ...
		 * calculate the most appropriate sample size itself according yo {@link #imageScaleType(com.universalimageloader.core.assist.ImageScaleType)}
		 * options.<br />
		...
		/** Sets auxiliary object which will be passed to {@link com.universalimageloader.core.download.ImageDownloader#getStream(String, Object)} */
		 ...
		 * {@link com.universalimageloader.core.imageaware.ImageAware image aware view} but
		...
		/**
		 * Sets custom {@link com.universalimageloader.core.display.BitmapDisplayer displayer} for image loading task. Default value -
		...
		/**
		 * Sets custom {@linkplain android.os.Handler handler} for displaying images and firing {@linkplain com.universalimageloader.core.listener.ImageLoadingListener
		 * listener} events.
		 */
	 ...
	 * <li>{@link com.universalimageloader.core.assist.ImageScaleType#IN_SAMPLE_POWER_OF_2} decoding type will be used</li>
	 * <li>{@link android.graphics.Bitmap.Config#ARGB_8888} bitmap config will be used for image decoding</li>
	 * <li>{@link com.universalimageloader.core.display.SimpleBitmapDisplayer} will be used for image displaying</li>
	 * </ul>
	 * <p/>
