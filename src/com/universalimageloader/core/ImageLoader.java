...
public class ImageLoader {
	 ...
	 * @param imageAware {@linkplain com.universalimageloader.core.imageaware.ImageAware Image aware view}
	 ...
	 * @param imageAware {@linkplain com.universalimageloader.core.imageaware.ImageAware Image aware view}
	 *                   which should display image
	 * @param listener   {@linkplain com.universalimageloader.core.listener.ImageLoadingListener Listener} for image loading process. Listener fires events on
	 ...
	 * @param imageAware {@linkplain com.universalimageloader.core.imageaware.ImageAware Image aware view}
	 *                   which should display image
	 * @param options    {@linkplain com.universalimageloader.core.DisplayImageOptions Options} for image
	 ...
	 *                         {@linkplain ImageLoaderConfiguration.Builder#defaultDisplayImageOptions(DisplayImageOptions)
	 *                         from configuration} will be used.
	 * @param listener         {@linkplain com.universalimageloader.core.listener.ImageLoadingListener Listener} for image loading process. Listener fires
	 *                         events on UI thread if this method is called on UI thread.
	 * @param progressListener {@linkplain com.universalimageloader.core.listener.ImageLoadingProgressListener
	 *                         Listener} for image loading progress. Listener fires events on UI thread if this method
	 *                         is called on UI thread. Caching on disk should be enabled in
	 *                         {@linkplain com.universalimageloader.core.DisplayImageOptions options} to make
	 *                         this listener work.
	 * @throws IllegalStateException    if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 * @throws IllegalArgumentException if passed <b>imageAware</b> is null
	 */
	 ...
	 * {@link com.universalimageloader.core.listener.ImageLoadingListener#onLoadingComplete(String, android.view.View, android.graphics.Bitmap)} callback}.
	 * <br />
	 * <b>NOTE:</b> {@link #init(ImageLoaderConfiguration)} method must be called before this method call
	 *
	 * @param uri      Image URI (i.e. "http://site.com/image.png", "file:///mnt/sdcard/image.png")
	 * @param listener {@linkplain com.universalimageloader.core.listener.ImageLoadingListener Listener} for image loading process. Listener fires events on UI
	 ...
	 *                        {@linkplain com.universalimageloader.core.listener.ImageLoadingListener#onLoadingComplete(String, android.view.View,
	 ...
	 * {@link com.universalimageloader.core.imageaware.ImageAware ImageAware}
	 */
	 ...
	 * {@link com.universalimageloader.core.imageaware.ImageAware ImageAware}.
	 *
	 * @param imageAware {@link com.universalimageloader.core.imageaware.ImageAware ImageAware} for
	 ...
	 * {@link com.universalimageloader.core.listener.ImageLoadingListener#onLoadingFailed(String, android.view.View, com.universalimageloader.core.assist.FailReason)} callback will be fired with
	 * {@link com.universalimageloader.core.assist.FailReason.FailType#NETWORK_DENIED}
	 *
	...
	/**
	 * Sets option whether ImageLoader will use {@link com.universalimageloader.core.assist.FlushedInputStream} for network downloads to handle <a
	 * href="http://code.google.com/p/android/issues/detail?id=6066">this known problem</a> or not.
	 *
	 * @param handleSlowNetwork pass <b>true</b> - to use {@link com.universalimageloader.core.assist.FlushedInputStream} for network downloads; <b>false</b>
	 *                          - otherwise.
	 */
	 ...
	 * {@linkplain com.universalimageloader.core.ImageLoaderConfiguration.Builder#taskExecutor(java.util.concurrent.Executor)
