 ...
 * @see com.universalimageloader.core.download.ImageDownloader
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>threadPoolSize = {@link com.universalimageloader.core.ImageLoaderConfiguration.Builder#DEFAULT_THREAD_POOL_SIZE this}</li>
	 * <li>threadPriority = {@link com.universalimageloader.core.ImageLoaderConfiguration.Builder#DEFAULT_THREAD_PRIORITY this}</li>
	 ...
	 * <li>diskCache = {@link com.universalimageloader.cache.disc.impl.UnlimitedDiscCache}</li>
	 ...
	 * <li>tasksProcessingOrder = {@link com.universalimageloader.core.assist.QueueProcessingType#FIFO}</li>
	...
	public static class Builder {
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, com.universalimageloader.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * @param processorForDiskCache      null-ok; {@linkplain com.universalimageloader.core.process.BitmapProcessor Bitmap processor} which process images before saving them in disc cache
		 */
		 ...
		 * <li>{@link #tasksProcessingOrder(com.universalimageloader.core.assist.QueueProcessingType)}</li>
		 * </ul>
		 *
		 ...
		 * Default value - {@link com.universalimageloader.core.assist.QueueProcessingType#FIFO}
		 */
		 ...
		 * {@link com.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.universalimageloader.cache.disc.impl.ext.LruDiscCache LruDiscCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(com.universalimageloader.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link com.universalimageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(com.universalimageloader.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link com.universalimageloader.cache.disc.impl.UnlimitedDiscCache
		 * BaseDiscCache}. Cache directory is defined by
		 * {@link com.universalimageloader.utils.StorageUtils#getCacheDirectory(android.content.Context)
		 ...
		 * Default value -
		 * {@link com.universalimageloader.core.DefaultConfigurationFactory#createImageDownloader(android.content.Context)
		 ...
		 * Default value -
		 * {@link com.universalimageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link com.universalimageloader.utils.L#disableLogging()} to disable
	 ...
	 * using {@link com.universalimageloader.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
